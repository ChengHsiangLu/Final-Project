...
![](/Users/samuellu/Desktop/GDC/Screenshot/Files.png?raw=true)
...
![](/Users/samuellu/Desktop/GDC/Screenshot/Cases.png?raw=true)
...
![](/Users/samuellu/Desktop/GDC/Screenshot/Manifest.png?raw=true)
...
![](/Users/samuellu/Desktop/GDC/Screenshot/all_files.png?raw=true)
                          ...
                          fileName = sampleFiles,
													...
													dds <- DESeqDataSetFromHTSeqCount(sampleTable = sampleTable,
													                                  directory = directory,
																														...
																														![](/Users/samuellu/Desktop/GDC/Screenshot/MAplot_res.png?raw=true)
																														...
																														![](/Users/samuellu/Desktop/GDC/Screenshot/MAplot_resLFC.png?raw=true)
																														...
																														```
																														![](/Users/samuellu/Desktop/GDC/Screenshot/MAplot_3.png?raw=true)
																														...
																														```
																														![](/Users/samuellu/Desktop/GDC/Screenshot/ENSG00000004809.12.png?raw=true)
																														![](/Users/samuellu/Desktop/GDC/Screenshot/ENSG00000205853.9.png?raw=true)

																														customized plotting.

																														![](/Users/samuellu/Desktop/GDC/Screenshot/customized plotcounts.png?raw=true)
																														...
																														**I do not see any difference between younggroup and oldgroup by plot counts right now.**
																														...
																														```
																														![](/Users/samuellu/Desktop/GDC/Screenshot/meanSdPlot_1.png?raw=true)
																														```
																														meanSdPlot(assay(vsd))
																														```
																														![](/Users/samuellu/Desktop/GDC/Screenshot/meanSdPlot_2.png?raw=true)
																														...
																														**Standard deviation and mean are calculated row-wise from the expression matrix.**
																														...
																														select <- order(rowMeans(counts(dds,normalized=TRUE)),
																																		...
																																		pheatmap(assay(ntd)[select,], cluster_rows=FALSE, show_rownames=FALSE,
																																				 ...
																																				 ```
																																				 ![](/Users/samuellu/Desktop/GDC/Screenshot/heatmap_1.png?raw=true)

																																				 ```
																																				 pheatmap(assay(vsd)[select,], cluster_rows=FALSE, show_rownames=FALSE,
																																				          cluster_cols=FALSE, annotation_col=df, show_colnames = FALSE)
																																						  ```
																																						  ![](/Users/samuellu/Desktop/GDC/Screenshot/heatmap_2.png?raw=true)
																																						  ...
																																						  pheatmap(sampleDistMatrix,
																																						           clustering_distance_rows=sampleDists,
																																								            clustering_distance_cols=sampleDists,
																																													 ...
																																													 ```
																																													 ![](/Users/samuellu/Desktop/GDC/Screenshot/heatmap_smsm.png?raw=true)
																																													 ...
																																													 ![](/Users/samuellu/Desktop/GDC/Screenshot/pca_1.png?raw=true)
																																													   ...
																																													   geom_point(size=2) +
																																													     xlab(paste0("PC1: ",percentVar[1],"% variance")) +
																																														   ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
																																														     coord_fixed()
																																															 ```
																																															 ![](/Users/samuellu/Desktop/GDC/Screenshot/pca_2.png?raw=true)
																																																																															   ...
																																																																															   get_downregulated <- function(df){
																																																																																   ...
																																																																																   key <- intersect(rownames(df)[which(df$log2FoldChange<=-1)], rownames(df)[which(df$pvalue<=0.05)])
																																																																																	   ...
																																																																																	   results <- as.data.frame((df)[which(rownames(df) %in% key),])
																																																																																		 ...
																																																																																		 ![](/Users/samuellu/Desktop/GDC/Screenshot/up_data.png?raw=true)

																																																																																		 However, when I put all my don genes into the website, I got zero set.

																																																																																		 ![](/Users/samuellu/Desktop/GDC/Screenshot/down_data.png?raw=true)
